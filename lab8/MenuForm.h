...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Text = L"Введіть своє ID";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Введіть своє ID";
			// 
			// MenuForm
			// 
